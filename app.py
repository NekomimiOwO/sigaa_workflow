...
ARQUIVO_CATALOGO = "elementos_sigaa.json"
ARQUIVO_TEXTOS = "textos_padrao.json"
...
# ==============================================================================
# 1. FUNÇÕES DE ARQUIVOS LOCAIS E CATÁLOGO
# ==============================================================================
...
# ==============================================================================
# 2. FUNÇÕES DE AUTOMAÇÃO SELENIUM, PREENCHIMENTO E VALIDAÇÃO DE TEXTO
# ==============================================================================
...
def encontrar_elemento_com_fallback(driver, wait, passo, retentativas=3, intervalo=1.0):
    ...
    if target_raw:
        ...
        lista_seletores.append((By.XPATH, f"//*[@id='{clean_id}']"))
...
def validar_texto_na_tela(driver, texto_esperado, timeout=5, retentativas=3, intervalo=1.0):
    ...
    for tentativa in range(retentativas):
        tempo_inicial = time.time()
        while time.time() - tentativa < timeout:
            try:
...
# ==============================================================================
# 3. GERENCIAMENTO DO NAVEGADOR UNIVERSAL
# ==============================================================================
...
with tab1:
    ...
    # --- ADICIONAR NOVOS PASSOS COM SELEÇÃO DE POSIÇÃO ---
    ...
    # --- LISTAGEM E REORDENAÇÃO DOS PASSOS ---
    ...
    # --- EXECUÇÃO DO WORKFLOW COM SUPORTE A PAUSA E CHECKPOINT ---
